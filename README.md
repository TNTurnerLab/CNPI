...
<div align="center">
    <img src=https://github.com/TNTurnerLab/CNPI/blob/main/New_Codes/photos/abstract4.png  alt="Graphical Abstract" width="600" />
</div>
...
## Selection Criteria for File Containing Region of Interest from the UCSC Genome Browser
   ...
   Output filename: RefSeq_Curated_6/12/24.bed   
   Output field separator: tsv (tab-separated)   
   File type returned: Plain text
   
   [UCSC Genome Table Browser](https://genome.ucsc.edu/cgi-bin/hgTables?hgsid=2365725401_lz88zrCUmlqgWakOGcY7SD0F83tx)   
